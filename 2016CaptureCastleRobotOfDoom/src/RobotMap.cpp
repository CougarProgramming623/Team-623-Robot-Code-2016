...
DigitalOutput* RobotMap::testUltrasonicPing = nullptr;
AnalogInput* RobotMap::testUltrasonicEcho = nullptr;

AnalogPotentiometer* RobotMap::potentiometer = nullptr;
BuiltInAccelerometer* RobotMap::accelerometer = nullptr;
Ultrasonic* RobotMap::ultrasonic = nullptr;
...
RobotMap::RobotMap() {
	...
	gyro = nullptr; //TODO: DECOMMNET LINE ABOVE AND DELETE THIS LINE
}
...
RobotMap::init() {
	...
	camera->StartAutomaticCapture("cam0"); //TODO: CHANGE BACK TO "cam1"
	...
	ultrasonic = new Ultrasonic(PORT_ULTRASONIC_PING , PORT_ULTRASONIC_ECHO , Ultrasonic::DistanceUnit::kMilliMeters);

	//TODO: TEST SENSORS dELete when Done
	testUltrasonicPing = new DigitalOutput(TEST_PORT_ULTRASONIC_PING);
	testUltrasonicEcho = new AnalogInput(TEST_PORT_ULTRASONIC_ECHO);
...
RobotMap::getUlrasonicFeet() {
	return (testUltrasonicEcho->GetVoltage() * 5000) / 1024 / .5;
}
