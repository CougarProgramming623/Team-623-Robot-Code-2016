...
// these lines or comment it out.
	...
	RobotMap::testUltrasonicPing->SetUpSourceEdge(true , false);
}
...
//The Button of the All Mighty Board of Buttons
	...
	//DriverStation::ReportError("UltraSonic: " + std::to_string(RobotMap::ultrasonic->GetRangeMM()) + "\n"); //Change for debugging //TODO: DE COMMENT THESE WHEN DONE WITH TESTING ULTRASONIC
	//DriverStation::ReportError("Potentiometer: " + std::to_string(RobotMap::potentiometer->Get()) + "\n"); //Change for debugging

	//TODO: TEST FOR ULTRASONIC DELETE WHEND DONE
	RobotMap::testUltrasonicPing->SetUpSourceEdge(false , true);
	Wait(.02);
	DriverStation::ReportError("Ultrasonic: " + std::to_string((RobotMap::testUltrasonicEcho->GetVoltage() * 5000) / 1024 / .33f) + "\n");
	RobotMap::testUltrasonicPing->SetUpSourceEdge(true , false);
	Wait(.02);
}
